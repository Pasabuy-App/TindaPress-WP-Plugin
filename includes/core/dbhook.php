...
<?php
	...
	// 	$tbl_products = TP_PREFIX.'products';
	// 	$tbl_address = TP_PREFIX.'address';
	// 	$tbl_categories = TP_PREFIX.'categories';
	// 	$tbl_orders = TP_PREFIX.'orders';
	// 	$tbl_order_items = TP_PREFIX.'order_items';
	// 	$tbl_personnels = TP_PREFIX.'personnels';
	// 	$tbl_plugin_config = TP_PREFIX.'plugin_config';
	// 	$tbl_revisions = TP_PREFIX.'revisions';
	// 	$tbl_roles = TP_PREFIX.'roles';
	// 	$tbl_roles_access = TP_PREFIX.'roles_access';
	// 	$tbl_stores = TP_PREFIX.'stores';
