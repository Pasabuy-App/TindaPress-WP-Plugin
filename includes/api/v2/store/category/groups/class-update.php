<?php
	...
	*/
    ...
    class TP_Store_Category_Group_Update_v2 {
        ...
        public static function catch_post(){
            ...
            isset($_POST['info']) && !empty($_POST['info']) ? $data['info'] =  $_POST['info'] :  $data['info'] = null ;
            return $data;
        }
        ...
        public static function listen_open($request){
            ...
            isset($_POST['title']) && !empty($_POST['title']) ? $posts['title'] =  $_POST['title'] :  $posts['title'] = $check_group->title ;
            isset($_POST['info']) && !empty($_POST['info']) ? $posts['info'] =  $_POST['info'] :  $posts['info'] = $check_group->info ;
            ...
            if($check_group->status == "inactive"){
                return array(
                    "status" => "unknown",
                    "message" => "This category group is currently inactive"
                );
            }
