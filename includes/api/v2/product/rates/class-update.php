<?php
	...
	*/
    ...
    class TP_Products_Ratings_Update_v2 {
        ...
        public static function listen_open(){
            ...
            isset($_POST['comments']) && !empty($_POST['comments'])? $user['comments'] =  $_POST['comments'] :  $user['comments'] = $get_rating->comments;
            ...
            if($user['rates'] != null){
                ...
                $user["rates"] = $get_rating->rates;

            }

            $import_data = $wpdb->query("INSERT INTO
                $tbl_ratings
                    (`hsid`, $tbl_ratings_field)
                VALUES
                    ( '$get_rating->hsid', '$get_rating->pdid',  '{$user["rates"]}',  '{$user["comments"]}', '{$user["wpid"]}' )");
