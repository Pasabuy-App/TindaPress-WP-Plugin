    ...
    class TP_Store_Nearme {
        ...
        public static function listen_open(){
            ...
            $results = $wpdb->get_results(" SELECT
                ...
                ROUND((SELECT `hp_distance_k`(( SELECT child_val FROM $table_dv_revision WHERE ID = dv_add.latitude ), ( SELECT child_val FROM $table_dv_revision WHERE ID = dv_add.longitude ) ,'$lat2', '$long2' ) ), 3)AS `distance`
            FROM
                $table_store tp_str
