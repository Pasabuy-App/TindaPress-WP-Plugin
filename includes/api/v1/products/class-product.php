    ...
    class TP_Products {
        ...
        public static function listen(){
            ...
            return rest_ensure_response( 
                TP_Products:: select_product_by_storeid_cat_id()
            );
        }

        // GET product by store  product category ID
        public static function select_product_by_storeid_cat_id(){
			...
			if (!isset($_POST["ctid"]) || !isset($_POST["types"]) || !isset($_POST["stid"])) {
				return array(
					"status" => "unknown",
			...
			if (empty($_POST["ctid"]) || empty($_POST["types"])  || empty($_POST["stid"])) {
				return array(
					"status" => "unknown",
