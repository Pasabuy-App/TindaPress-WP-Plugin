<?php
	...
	*/
    ...
    class TP_Product_List_All {

        public static function listen(){
            return rest_ensure_response( 
                TP_Product_List_All:: list_all()
            );
        }
        ...
        public static function list_all(){
            ...
            $result = $wpdb->get_results("SELECT
                ...
                ( SELECT tp_rev.child_val FROM $table_revs tp_rev WHERE ID = (SELECT `title` FROM tp_stores WHERE ID  = tp_prod.stid ) ) AS `store _name`,
