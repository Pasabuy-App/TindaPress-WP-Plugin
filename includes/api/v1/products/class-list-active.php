<?php
	...
	*/
    ...
    class TP_Product_List_Active {

        public static function listen(){
            return rest_ensure_response( 
                TP_Product_List_Active:: list_active()
            );
        }

        //QA done 2020-08-12 4:18pm
        public static function list_active(){
            ...
            WHERE
                ( SELECT tp_rev.child_val FROM $table_revs tp_rev WHERE ID = tp_prod.status ) = 1
            GROUP BY
                tp_prod.ID ");
